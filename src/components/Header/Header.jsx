...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar — rendered as sibling of header to escape its backdrop-filter stacking context */}
      <div
      ...
      >
        ...
        />
        <div
          className={`absolute right-0 top-0 h-full w-[80%] max-w-sm bg-ink-900/95 backdrop-blur-xl border-l border-white/10 shadow-2xl transition-transform duration-300 ${
            sidebarOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
          style={{
            backgroundColor: '#0a0c14',
            backgroundImage:
              'linear-gradient(180deg, rgba(15,18,32,0.95), rgba(10,12,20,0.95))',
          }}
        >
                ...
                className={({ isActive }) =>
                  `px-4 py-3 rounded-xl font-semibold transition-all ${
                    isActive
                      ...
                      : 'text-slate-300 border border-white/10 hover:border-cyan-400/40 hover:bg-white/10 bg-ink-900/70'
                  }`
                }
              >
